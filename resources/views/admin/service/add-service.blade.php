...
<div class="container">
        ...
        <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
          ...
          <form action="{{route('new.service')}}" method="post" >
            @csrf
                ...
                @endif
            <div class="row">
                <label class="col-sm-4 form-control-label"> Service Name: <span class="tx-danger">*</span></label>
              ...
              <div class="row mt-2">
                <label class="col-sm-4 form-control-label"> Service Descipsion: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" @error('service_descripsion') is-invalid @enderror name="service_descripsion" placeholder=" Service Name">
                </div>
              </div><!-- row -->
              <div class="row mt-2">
                <label class="col-sm-4 form-control-label"> Service icon: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" @error('service_icone') is-invalid @enderror name="service_icone" placeholder=" Service Icone">
                    {{-- <div class="mt-2" style="overflow-y:scroll; height:150px">
                        @php
  ...
  "fa-y-combinator","fa-yahoo","fa-yelp","fa-yoast","fa-youtube","fa-youtube-play","fa-youtube-square");
                    ...
                    @endphp
                      ...
                      <div class=" fronasowm_icon badge badge-dark p-2 m-1">
                          <i class="fa {{$icon}}"></i>
                        </div>
                      @endforeach
